...
import (
	...
	"gitlab.com/kieran-osgood/pkg/todo"
)
...
func (t *ToDoService) Create(text string, isDone bool) (*string, error) {
...
func (t *ToDoService) Update(id string, text string, isDone bool) error {
...
func (t *ToDoService) Get(id string) (*todo.ToDoItem, error) {
...
func (t *ToDoService) List() ([]todo.ToDoItem, error) {
...
func (t *ToDoService) getConnection() *pgxpool.Pool {
...
func (t *ToDoService) getDBConnectionString() string {
